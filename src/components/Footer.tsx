    ...
    <footer className="bg-white border-t border-gray-200 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-sm hover:underline">Our Mission</a></li>
              <li><a href="#" className="text-sm hover:underline">How It Works</a></li>
              <li><a href="#" className="text-sm hover:underline">Medical Advisory Board</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-sm hover:underline">Health Articles</a></li>
              <li><a href="#" className="text-sm hover:underline">FAQs</a></li>
              <li><a href="#" className="text-sm hover:underline">Symptom Guide</a></li>
              <li><a href="#" className="text-sm hover:underline">Local Health Resources</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm hover:underline">Medical Disclaimer</a></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 text-center">
          <p className="text-sm">&copy; {new Date().getFullYear()} AI HealthBridge. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
